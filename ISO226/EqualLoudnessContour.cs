...
namespace NokitaKaze.ISO226
{
    public static class EqualLoudnessContour
    {
        ...
        public static readonly IReadOnlyList<double> iso_a_f = new[]
        {
            ...
            0.259, 0.253, 0.250, 0.246, 0.244, 0.243, 0.243, 0.243, 0.242, 0.242, 0.245, 0.254, 0.271, 0.301, 0.31, 0.33
        };
        ...
        public static readonly IReadOnlyList<double> iso_L_u = new[]
        {
            ...
            0.0, -2.7, -4.1, -1.0, 1.7, 2.5, 1.2, -2.1, -7.1, -11.2, -10.7, -3.1, -2, -35
        };
        ...
        public static readonly IReadOnlyList<double> iso_T_f = new[]
        {
            ...
            1.7, -1.3, -4.2, -6.0, -5.4, -1.5, 6.0, 12.6, 13.9, 12.3, 17, 80
        };
